...
class MainMenu(Menu):
    ...
    def display_menu(self): # Aparência do Menu
        ...
        while self.run_display:
            ...
            self.game.draw_text('Bem-Vindo', 40, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 8)
            self.game.draw_text("I Coríntios 9:19-22 ", 15, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 4)
...
class OptionsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Lança Biblia:  F", 15, self.shotx, self.shoty)
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('CRIADOR', 20, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 4 - 20)
            self.game.draw_text('João M J Braga', 28, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 10)
            self.game.draw_text("Voltar: Backspace", 10, self.mid_w-200, self.mid_h + 190)
            self.game.draw_text("Avançar: Enter", 10, self.mid_w+200, self.mid_h + 190)
            self.blit_screen()