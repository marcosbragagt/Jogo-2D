...
class Game():
    def __init__(self):
        ...
        self.BLACK, self.WHITE = (0, 0, 23), (255, 255, 255) #Definindo cores
...
#INICIO
            ...
            bg = pygame.image.load("Cenario\Cenario2.jpg")
            ...
            bullet_img = pygame.transform.scale(pygame.image.load(os.path.join('Bullets', 'biblia.png')), (60, 60))
            x = 100
            y = 395
            radius = 80
            vel = 5
            ...
            class Hero:
                ...
                def jump_motion(self, userInput):
                    if userInput[pygame.K_SPACE] and self.jump is False:
                        jumpvar = pygame.mixer.Sound('Musicas\Pula.wav')
                        jumpvar.play()
                        self.jump = True
                    if self.jump:
                        self.y -= self.vely * 2
                ...
                def shoot(self):
                    ...
                    if (userInput[pygame.K_f] and self.cool_down_count == 0):
                        shootvar=pygame.mixer.Sound('Musicas\Atira.wav')
                        shootvar.play()
            ...
            def draw_game():
                ...
                if player.alive == False:
                    ...
                    #aukdio_Fim = pygame.mixer.Sound('Musicas\GameOver.wav')
                    #aukdio_Fim.play()
                    ...
                    if userInput[pygame.K_r]:
                        ...
                        player.lives = 1
                        player.health = 40
                        Continua_audio = pygame.mixer.Sound('Musicas\continue.wav')
                        Continua_audio.play()
                    
                        
                font = pygame.font.Font('fonte/PressStart2P-vaV7.ttf', 27)
                text = font.render('Vidas Salvas: ' + str(kills) + ' Chance: ' + str(player.lives), True, (50, 205, 50))
